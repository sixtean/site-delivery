...
function Login() {
    ...
    useTitle("Zoryon Wipe", isLogin ? "Login" : "Registro");
            ...
            <section className="w-full max-w-md">
                <article className="bg-gray-900 rounded-2xl shadow-lg p-8">
                    <header className="flex items-center mb-6">
                        <img src={logo} alt="logo Zorion" className="w-6"/>
                    ...
                    <article className="text-center text-gray-400 space-y-4">
                        ...
                        <address className="text-primary font-medium not-italic">
                            Email: <a href="mailto:suporte@szoryonwipe.com" className="text-red-500">suporte@zoryonwipe.com</a>
                        </address>
                    </article>
                )}
